...
public class Dashboard extends DashboardModule {
    ...
    public final Input<Integer> leftDriveRate = addDashboardInput("leftDriveRate", 0);
    public final Input<Integer> rightDriveRate = addDashboardInput("rightDriveRate", 0);
