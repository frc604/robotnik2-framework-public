...
public class Ports {
    ...
    // Encoders
	// AZ change these to real
    public static final int ENCODER_LEFT_A = 0; // three wires
    public static final int ENCODER_LEFT_B = 1; // one blue wire
    public static final int ENCODER_RIGHT_A = 2;
    public static final int ENCODER_RIGHT_B = 3;
    
    // these are biult in i have no idea what the fuck is going on here
