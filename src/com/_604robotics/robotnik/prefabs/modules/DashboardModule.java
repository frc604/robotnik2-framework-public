...
public class DashboardModule extends Module {
  ...
  protected <E extends Enum<E>> Output<E> addDashboardOutput(
      String name, E defaultValue, Class<E> klass) {
        ...
        switch (input.getValue()) {
          ...
          case NUMBER:
            SmartDashboard.putNumber(
                input.getKey().getName(), ((Number) input.getKey().get()).doubleValue());
            break;
          case STRING:
